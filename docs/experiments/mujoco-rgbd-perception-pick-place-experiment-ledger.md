...
```yaml
closure_id: CLOSE-EXP-017-001
recorded_at: 2026-08-26T12:25:28+08:00
experiment_id: EXP-017
status: VALID
classification: accepted_task_start_full_restart
runtime_source_commit: 69ebd9acaf032f728799ea3a80a1948f1f5ed414
implementation_commit: a8b3d87ac08dc124e0d54f27fbee93f62c8cfb4a
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
observed:
  - OBSERVED: Fresh production perception consumed task_camera_frame 640x480 CameraPlugin RGB-D, selected 141 cup points from 98103 full points, wrote a nonempty 4013-byte PLY, fitted radius 0.03938151231973142 m, and published world [0.01950111783349788, -0.28040476095521005, 0.165] at source stamp 3443999999. Error to task_start is 0.000642429 m and error to the immediate MuJoCo sample is within 0.01 m.
  ...
  - OBSERVED: The workflow reached DONE with all 19 expected transitions. Arm trajectory/FK/joint targets changed through approach, lift, transport, place and retreat; gripper targets changed from close -0.0485 rad to open 0.75 rad, and every controller execution completed successfully.
  - OBSERVED: Physical truth remained table-supported before grasp, obtained bilateral unsupported contact, lifted from z=0.1668942457 to z=0.2249125528, carried with bilateral contact, detached before open, and released to table-supported [-0.0777706060, -0.2475471776, 0.1648354858] with zero finger contacts and near-zero linear/angular velocity.
  - OBSERVED: final_xy_error_m=0.0026447258 and final_upright_tilt_rad=0.0047441741 pass policy. Planning Scene ends detached with attached_object_ids=[] and world primitive counts pedestal=1, plastic_cup=13, table=1.
  - OBSERVED: Concurrent CUA captured three distinct 1568x862 PNGs in the same session. Inspection shows: baseline initial orange cup/open gripper/red target; transport cup visibly off the table and held while target remains empty; final cup inside the red target with open gripper retreating. All screenshots show Running status and agree with their manifest boundaries.
  - OBSERVED: Capture coordinator exit=0 and natural launch exit=0. All required processes report clean exits; unlike EXP-015/016, no context-invalid/FATAL/Traceback shutdown diagnostic appears.
  - OBSERVED: Post-cleanup exact child, domain 195, partition owners, owned tmux, Viewer, and CUA session are empty.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/acceptance-gates.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/run/full-restart.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/run/full-restart.exit
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/run/capture-coordinator.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/run/capture-coordinator.exit
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/run.d/rgbd-pick-task-start-exp017-20260826/perception/summary.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/run.d/rgbd-pick-task-start-exp017-20260826/perception/cup.ply
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/run.d/rgbd-pick-task-start-exp017-20260826/dynamic/dynamic-execute-manifest.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/gui/viewer-baseline.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/gui/viewer-transport.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/gui/viewer-final.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-017/post-cleanup.log
conclusion: task_start has one accepted, countable FULL_RESTART RGB-D-driven physical pick-place with complete numeric, physical, Planning Scene, controller, visual, natural-exit, and cleanup evidence.
decision: KEEP
next_experiment: EXP-018
```

```yaml
correction_id: CORR-EXP-012-014-001
recorded_at: 2026-08-26T12:25:28+08:00
scope: [EXP-012, EXP-013, EXP-014]
historical_status: PLANNED
correction:
  - Those frozen plans name implementation 9854a62f, which the real EXP-011 launch proved cannot accept ROS launch arguments. They were never transitioned to RUNNING and must not be executed or silently rewritten.
  - The user-approved a8b3d87a CLI fix and the accepted EXP-017 concurrent visual protocol are now mandatory. Replacement plans EXP-018 through EXP-020 preserve the three initial keyframes and all product criteria while updating provenance and evidence orchestration explicitly.
```
...
lifecycle: FULL_RESTART
hypothesis: With only initial_keyframe=cup_test_forward_5cm, the accepted implementation and concurrent visual protocol complete the same physical RGB-D pick-place from [0.02, -0.33, 0.165].
single_variable: initial_keyframe=cup_test_forward_5cm
provenance: {implementation_commit: a8b3d87ac08dc124e0d54f27fbee93f62c8cfb4a, submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08, ros_domain_id: 196, gz_partition: rgbd-pick-forward-exp018-20260826, session_id: rgbd-pick-forward-exp018-20260826, owned_tmux_session: rgbd-pick-exp018-20260826}
initial_cup_xyz_m: [0.02, -0.33, 0.165]
evidence_root: /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-018/
success_criteria: SAME_AS_EXP_011
invalid_criteria: SAME_AS_EXP_011
decision: PENDING
```
...
lifecycle: FULL_RESTART
hypothesis: With only initial_keyframe=cup_test_left_5cm, the accepted implementation and concurrent visual protocol complete the same physical RGB-D pick-place from [-0.03, -0.28, 0.165].
single_variable: initial_keyframe=cup_test_left_5cm
provenance: {implementation_commit: a8b3d87ac08dc124e0d54f27fbee93f62c8cfb4a, submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08, ros_domain_id: 197, gz_partition: rgbd-pick-left-exp019-20260826, session_id: rgbd-pick-left-exp019-20260826, owned_tmux_session: rgbd-pick-exp019-20260826}
initial_cup_xyz_m: [-0.03, -0.28, 0.165]
evidence_root: /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/
success_criteria: SAME_AS_EXP_011
invalid_criteria: SAME_AS_EXP_011
decision: PENDING
```
...
lifecycle: FULL_RESTART
hypothesis: With only initial_keyframe=cup_test_right_5cm, the accepted implementation and concurrent visual protocol complete the same physical RGB-D pick-place from [0.07, -0.28, 0.165].
single_variable: initial_keyframe=cup_test_right_5cm
provenance: {implementation_commit: a8b3d87ac08dc124e0d54f27fbee93f62c8cfb4a, submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08, ros_domain_id: 198, gz_partition: rgbd-pick-right-exp020-20260826, session_id: rgbd-pick-right-exp020-20260826, owned_tmux_session: rgbd-pick-exp020-20260826}
initial_cup_xyz_m: [0.07, -0.28, 0.165]
evidence_root: /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-020/
success_criteria: SAME_AS_EXP_011
invalid_criteria: SAME_AS_EXP_011
decision: PENDING
```
...
current_hypothesis: The accepted task_start chain generalizes when only each named initial keyframe changes.
working_tree_status: Task worktree, exact f19 submodule, and canonical main are clean before this ledger append; no runtime artifact is in source.
owned_processes: NONE; EXP-017 exact child, domain, partition, tmux, Viewer, and CUA are empty.
preserved_processes: Existing unrelated tmux/processes and canonical main were not operated or modified.
confirmed_conclusions:
  - EXP-017 is the first accepted task_start FULL_RESTART and satisfies every frozen gate.
  - EXP-012 through EXP-014 remain historical unrun plans tied to a disproven implementation and are superseded by EXP-018 through EXP-020 without rewriting history.
open_risks:
...
recorded_at: 2026-08-26T12:33:13+08:00
experiment_id: EXP-019
from: PLANNED
to: RUNNING
source_commit: f9d325e9376a7407aecabc74db89b7c9892991fa
implementation_commit: a8b3d87ac08dc124e0d54f27fbee93f62c8cfb4a
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
pre_running_observed:
  - OBSERVED: Generic evidence-only wrappers pass zsh syntax checks and preserve the accepted EXP-017/018 coordinator boundaries.
  - OBSERVED: Task source is clean at f9d325e9; gitlink and clean submodule HEAD both equal exact f19 with describe so101-0.0.3-r8-3-gf19a8cc. Canonical main is clean at b3770360.
  - OBSERVED: Domain 197 has no nodes, no process argument names the left partition, owned tmux is absent, and exact-title Viewer count is zero.
  - OBSERVED: Window-scope CUA session rgbd-pick-exp019-viewer-20260826 is active before launch.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/pre-running/isolation-snapshot.log
next_command: Start concurrent capture and full-restart launch with runtime session rgbd-pick-left-exp019-20260826 and the sole product change cup_test_left_5cm.
```

```yaml
closure_id: CLOSE-EXP-019-001
recorded_at: 2026-08-26T12:35:57+08:00
experiment_id: EXP-019
status: VALID
classification: accepted_left_full_restart
runtime_source_commit: 125dd0178835f8d0e319abfa37d50cb41fbd953a
implementation_commit: a8b3d87ac08dc124e0d54f27fbee93f62c8cfb4a
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
observed:
  - OBSERVED: Fresh production perception consumed task_camera_frame 640x480 CameraPlugin RGB-D, selected 377 cup points from 98144 full points, wrote a nonempty 10385-byte PLY, fitted radius 0.03936645986051382 m, and published world [-0.030372113183230905, -0.28058403684321176, 0.165] at source stamp 4353999999. Error to cup_test_left_5cm is 0.000692508 m and passes the frozen 0.01 m bound.
  - OBSERVED: Launch topology started exactly one rgbd_cup_pose and one dynamic_cup_pick_place after scene_setup; no truth bridge or cup_pose_tf_demo process started. The workflow consumed that same initial world pose and source stamp.
  - OBSERVED: The workflow reached DONE with all 19 expected transitions. Arm trajectory/FK/joint targets changed through approach, lift, transport, place and retreat; gripper targets changed from close to open, and controller executions completed successfully.
  - OBSERVED: Physical truth began table-supported at [-0.03, -0.28, 0.1648015925], obtained bilateral unsupported contact, lifted from z=0.1669407228 to z=0.2249055315, transported with bilateral contact, detached before open, and released table-supported at [-0.0779099893, -0.2474572155, 0.1649537081] with zero finger contacts and near-zero velocity.
  - OBSERVED: final_xy_error_m=0.0024857565 and final_upright_tilt_rad=0.0077366118 pass policy. Planning Scene ends detached with attached_object_ids=[] and world primitive counts pedestal=1, plastic_cup=13, table=1.
  - OBSERVED: The concurrent coordinator captured three distinct 1568x862 same-session PNGs. Direct inspection shows the left-shifted baseline cup with open gripper, the cup visibly off the table and held during transport above an empty red target, and the released cup inside the target with the gripper open/retreating.
  - OBSERVED: Capture coordinator exit=0 and natural launch exit=0. All required processes report clean exits; post-cleanup exact child, domain 197, partition owners, owned tmux, Viewer, and CUA session are empty.
retained_risk:
  - OBSERVED: rgbd_cup_pose rejected transient motion/occlusion frames whose fitted radius exceeded tolerance, then resumed valid estimates; the workflow input remains the frozen accepted initial sample. This fail-closed streaming behavior did not alter the dynamic input.
  - OBSERVED: ros2_control_node emitted two pal_statistics publisher-thread context-invalid diagnostics during shutdown, then reported a clean process exit. As in EXP-018, this remains a nonfatal shutdown risk.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/acceptance-gates.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/run/full-restart.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/run/full-restart.exit
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/run/capture-coordinator.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/run/capture-coordinator.exit
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/run.d/rgbd-pick-left-exp019-20260826/perception/summary.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/run.d/rgbd-pick-left-exp019-20260826/perception/cup.ply
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/run.d/rgbd-pick-left-exp019-20260826/dynamic/dynamic-execute-manifest.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/gui/viewer-baseline.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/gui/viewer-transport.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/gui/viewer-final.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-019/post-cleanup.log
conclusion: cup_test_left_5cm has one accepted, countable FULL_RESTART RGB-D-driven physical pick-place with complete numeric, physical, Planning Scene, controller, visual, natural-exit, and cleanup evidence.
decision: KEEP
...
current_hypothesis: The accepted chain now generalizes to task_start, forward, and left; right remains the final sole keyframe variable.
working_tree_status: Task source and exact f19 submodule are clean before this ledger append; canonical main remains clean at b3770360b26fe8f6fac0e19338d250b6f5cab0e7.
owned_processes: NONE; EXP-019 exact child, domain 197, partition, tmux, Viewer, and CUA are empty.
preserved_processes: Existing unrelated tmux/processes and canonical main were not operated or modified.
confirmed_conclusions:
  - EXP-017 task_start, EXP-018 forward, and EXP-019 left are accepted independent FULL_RESTART runs under implementation a8b3d87a and exact f19.
open_risks:
  - Right position generalization remains untested.
...
```yaml
transition_id: TRANS-EXP-026-RUNNING-001
recorded_at: 2026-08-26T15:19:47+08:00
experiment_id: EXP-026
from: PLANNED
to: RUNNING
source_commit: e71777120b421974efa07335b31a22f034c61319
implementation_commit: 48349ca7f6134e7bc4d15385338f86e5fbc182e7
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
pre_running_observed:
  - OBSERVED: Task source is clean at e7177712; gitlink and clean submodule HEAD equal exact f19 with expected describe, and canonical main remains clean at b3770360.
  - OBSERVED: Domain 204, exact forward runtime/launch/Viewer process set, task-owned tmux, exact Viewer title, and CUA identity were empty.
  - OBSERVED: New exp-026 nominal/derived/session evidence identities were absent before creation of only the allowed empty parents; production must allocate the session exclusively.
  - OBSERVED: Strict window-scope CUA session rgbd-pick-exp026-viewer-20260826 is active with desktop_unlocked=false.
single_variable: Change only the frozen initial keyframe from task_start to cup_test_forward_5cm; implementation, overlay, policy, geometry, harness, and gates are unchanged from accepted EXP-025.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/pre-running/isolation-snapshot.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/pre-running/cua-start.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/pre-running/cua-state.json
next_command: Commit and push this transition, then run explicit-zsh capture and full restart concurrently on domain 204 for cup_test_forward_5cm.
```

```yaml
closure_id: CLOSE-EXP-026-001
recorded_at: 2026-08-26T15:22:35+08:00
experiment_id: EXP-026
status: VALID
classification: accepted_hardened_forward_full_restart
runtime_source_commit: a7d1905cfde7a85a2b75363b72bacda748e204c8
implementation_commit: 48349ca7f6134e7bc4d15385338f86e5fbc182e7
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
observed:
  - OBSERVED: Fresh production perception consumed task_camera_frame 640x480 CameraPlugin RGB-D, selected 167 cup points from 98123 full points, wrote a nonempty PLY, fitted radius 0.03940726730185719 m, and published world [0.01962016787985498, -0.3304561742331846, 0.165] at source stamp 4225999999. Error to cup_test_forward_5cm is 0.000593605 m.
  - OBSERVED: Exactly one production perception process and one dynamic workflow started after scene setup; no truth bridge or cup_pose_tf_demo started. The workflow consumed the identical pose and unique exact producer stamp.
  - OBSERVED: Exact session rgbd-pick-forward-exp026-20260826 and reset epoch 0 passed preflight. The workflow reached DONE with transition_count=19 and the full expected trace, with changing controller trajectories, joint targets, FK poses, and close/open gripper targets.
  - OBSERVED: Physical truth began table-supported at the forward keyframe, achieved bilateral unsupported grasp, lifted from z=0.1668730868 to z=0.2248126341, and transported to [-0.0761617759, -0.2470482300, 0.2282922661] with bilateral contact and no table contact. Detach preceded open.
  - OBSERVED: Final release is table-supported at [-0.0779468393, -0.2475134799, 0.1648357584] with zero finger contacts and near-zero velocity. final_xy_error_m=0.0024663271 and final_upright_tilt_rad=0.0047696916 pass policy; final Planning Scene is detached with pedestal=1, plastic_cup=13, table=1.
  - OBSERVED: Direct inspection of three distinct 1568x862 same-window PNGs shows the forward-shifted baseline cup with open gripper, the cup raised and held during transport while the target is otherwise empty, and the released cup inside the red target with the gripper open above it.
  - OBSERVED: Launch and coordinator naturally exited 0; all required processes report clean exits. Exact child, domain 204, runtime session/partition process set, tmux, Viewer, and CUA are empty after cleanup.
retained_risk:
  - OBSERVED: Streaming perception fail-closed rejected 134 motion/occlusion frames after the accepted input; none replaced the exact workflow input.
  - OBSERVED: ros2_control_node emitted two pal_statistics context-invalid shutdown diagnostics, then exited cleanly. This remains a nonfatal retained shutdown risk.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/acceptance-gates.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/run/full-restart.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/run/full-restart.exit
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/run/capture-coordinator.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/run/capture-coordinator.exit
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/run.d/rgbd-pick-forward-exp026-20260826/perception/summary.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/run.d/rgbd-pick-forward-exp026-20260826/perception/cup.ply
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/run.d/rgbd-pick-forward-exp026-20260826/dynamic/dynamic-execute-manifest.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/gui/viewer-baseline.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/gui/viewer-transport.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/gui/viewer-final.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-026/post-cleanup.log
conclusion: cup_test_forward_5cm has one accepted, countable hardened FULL_RESTART RGB-D-driven physical pick-place with complete numeric, identity, physical, Planning Scene, controller, visual, natural-exit, and cleanup evidence.
decision: KEEP
...
current_hypothesis: Hardened behavior now generalizes across task_start and forward; left remains the next sole keyframe variable.
working_tree_status: Task source and exact f19 submodule are clean before this ledger append; canonical main remains clean at b3770360b26fe8f6fac0e19338d250b6f5cab0e7.
owned_processes: NONE; EXP-026 exact child, domain 204, runtime session/partition process set, tmux, Viewer, and CUA are empty.
preserved_processes: Existing unrelated tmux/processes and canonical main were not operated or modified.
confirmed_conclusions:
  - EXP-025 task_start and EXP-026 forward are accepted independent FULL_RESTART runs under hardened implementation 48349ca7 and exact f19.
open_risks:
  - Left and right generalization remain untested under the hardened implementation.
  - Nonfatal pal_statistics shutdown diagnostics and fail-closed post-input frame rejects remain retained for final reporting.
next_command: Commit and push this closure, then prove fresh domain 205/session/evidence/Viewer/CUA isolation and transition EXP-027 only to RUNNING.
```

```yaml
transition_id: TRANS-EXP-027-RUNNING-001
recorded_at: 2026-08-26T15:23:50+08:00
experiment_id: EXP-027
from: PLANNED
to: RUNNING
source_commit: ce583cf4f6d9522afc178ba69b82bf5067e5e694
implementation_commit: 48349ca7f6134e7bc4d15385338f86e5fbc182e7
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
pre_running_observed:
  - OBSERVED: Task source is clean at ce583cf4; exact f19 gitlink/submodule/describe and clean canonical main b3770360 are preserved.
  - OBSERVED: Domain 205, exact left runtime/launch/Viewer process set, task-owned tmux, exact Viewer title, CUA identity, and all nominal/derived/session evidence identities were empty.
  - OBSERVED: Only the allowed empty evidence parents now exist; production must allocate the session exclusively. Strict window-scope CUA session rgbd-pick-exp027-viewer-20260826 is active and desktop remains locked.
single_variable: Change only the frozen initial keyframe from cup_test_forward_5cm to cup_test_left_5cm; all source, overlay, policy, geometry, harness, and gates are unchanged.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/pre-running/isolation-snapshot.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/pre-running/cua-start.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/pre-running/cua-state.json
next_command: Commit and push this transition, then run explicit-zsh capture and full restart concurrently on domain 205 for cup_test_left_5cm.
```

```yaml
closure_id: CLOSE-EXP-027-001
recorded_at: 2026-08-26T15:26:35+08:00
experiment_id: EXP-027
status: VALID
classification: accepted_hardened_left_full_restart
runtime_source_commit: fec3492f6b3936329515e3927b1501b64e75546f
implementation_commit: 48349ca7f6134e7bc4d15385338f86e5fbc182e7
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
observed:
  - OBSERVED: Fresh production perception consumed task_camera_frame 640x480 CameraPlugin RGB-D, selected 377 cup points from 98180 full points, wrote a nonempty PLY, fitted radius 0.03936645986051382 m, and published world [-0.030372113183230905, -0.28058403684321176, 0.165] at source stamp 4107999999. Error to cup_test_left_5cm is 0.000692508 m.
  - OBSERVED: Exactly one rgbd_cup_pose and one dynamic_cup_pick_place started after scene setup; no truth bridge or cup_pose_tf_demo started. Dynamic input equals the accepted perception pose and unique source stamp.
  - OBSERVED: Session rgbd-pick-left-exp027-20260826/reset epoch 0 passed preflight. The workflow reached DONE with transition_count=19 and the full trace, with changed controller trajectories, FK poses, joint targets, and close/open gripper targets.
  - OBSERVED: Physical truth achieved bilateral unsupported grasp, lifted from z=0.1668853306 to z=0.2248743733, and transported to [-0.0764200661, -0.2476237910, 0.2281264378] with bilateral contact and no table contact. Detach preceded open.
  - OBSERVED: Release ended table-supported at [-0.0778824639, -0.2474628542, 0.1649480690] with zero finger contacts and near-zero velocity. final_xy_error_m=0.0025137821 and final_upright_tilt_rad=0.0075999928 pass policy; final Planning Scene is detached with pedestal=1, plastic_cup=13, table=1.
  - OBSERVED: Three distinct 1568x862 same-window images were directly inspected: left-shifted table-supported baseline with open gripper, visibly raised bilateral transport above an empty red target, and released cup inside the target with gripper open above it.
  - OBSERVED: Launch and coordinator naturally exited 0 and every required process reports a clean exit. Exact child, domain 205, session/partition process set, tmux, Viewer, and CUA are empty after cleanup.
retained_risk:
  - OBSERVED: Streaming perception fail-closed rejected 76 motion/occlusion frames after the accepted input; none was consumed by the workflow.
  - OBSERVED: ros2_control_node emitted two pal_statistics context-invalid shutdown diagnostics, then exited cleanly; retain as nonfatal shutdown risk.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/acceptance-gates.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/run/full-restart.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/run/full-restart.exit
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/run/capture-coordinator.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/run/capture-coordinator.exit
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/run.d/rgbd-pick-left-exp027-20260826/perception/summary.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/run.d/rgbd-pick-left-exp027-20260826/perception/cup.ply
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/run.d/rgbd-pick-left-exp027-20260826/dynamic/dynamic-execute-manifest.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/gui/viewer-baseline.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/gui/viewer-transport.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/gui/viewer-final.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-027/post-cleanup.log
conclusion: cup_test_left_5cm has one accepted, countable hardened FULL_RESTART RGB-D-driven physical pick-place with complete numeric, identity, physical, Planning Scene, controller, visual, natural-exit, and cleanup evidence.
decision: KEEP
...
current_hypothesis: Hardened behavior now generalizes across task_start, forward, and left; right is the final sole keyframe variable.
working_tree_status: Task source and exact f19 submodule are clean before this ledger append; canonical main remains clean at b3770360b26fe8f6fac0e19338d250b6f5cab0e7.
owned_processes: NONE; EXP-027 exact child, domain 205, runtime session/partition process set, tmux, Viewer, and CUA are empty.
preserved_processes: Existing unrelated tmux/processes and canonical main were not operated or modified.
confirmed_conclusions:
  - EXP-025 task_start, EXP-026 forward, and EXP-027 left are accepted independent FULL_RESTART runs under hardened implementation 48349ca7 and exact f19.
open_risks:
  - Right generalization remains untested under the hardened implementation.
  - Nonfatal pal_statistics shutdown diagnostics and fail-closed post-input frame rejects remain retained for final reporting.
next_command: Commit and push this closure, then prove fresh domain 206/session/evidence/Viewer/CUA isolation and transition EXP-028 only to RUNNING.
```

```yaml
transition_id: TRANS-EXP-028-RUNNING-001
recorded_at: 2026-08-26T15:27:45+08:00
experiment_id: EXP-028
from: PLANNED
to: RUNNING
source_commit: 0e54bbd9ae2ae42dbf6d7e66fdbfc02d297f4b9e
implementation_commit: 48349ca7f6134e7bc4d15385338f86e5fbc182e7
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
pre_running_observed:
  - OBSERVED: Task source is clean at 0e54bbd9; exact f19 gitlink/submodule/describe and clean canonical main b3770360 are preserved.
  - OBSERVED: Domain 206, exact right runtime/launch/Viewer process set, task-owned tmux, exact Viewer title, CUA identity, and all nominal/derived/session evidence identities were empty.
  - OBSERVED: Only allowed empty evidence parents exist; production must allocate the session exclusively. Strict window-scope CUA session rgbd-pick-exp028-viewer-20260826 is active with desktop_unlocked=false.
single_variable: Change only the frozen initial keyframe from cup_test_left_5cm to cup_test_right_5cm; source, overlay, policy, geometry, harness, and gates are unchanged.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/pre-running/isolation-snapshot.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/pre-running/cua-start.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/pre-running/cua-state.json
next_command: Commit and push this transition, then run explicit-zsh capture and full restart concurrently on domain 206 for cup_test_right_5cm.
```

```yaml
closure_id: CLOSE-EXP-028-001
recorded_at: 2026-08-26T15:30:41+08:00
experiment_id: EXP-028
status: VALID
classification: accepted_hardened_right_full_restart
runtime_source_commit: d741f12e1216ae9407e30702c87e9dab9e149709
implementation_commit: 48349ca7f6134e7bc4d15385338f86e5fbc182e7
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
observed:
  - OBSERVED: Fresh production perception consumed task_camera_frame 640x480 CameraPlugin RGB-D, selected 125 cup points from 98087 full points, wrote a nonempty PLY, fitted radius 0.03945093696604867 m, and published world [0.06963473821765558, -0.2805149484127753, 0.165] at source stamp 5533999999. Error to cup_test_right_5cm is 0.000631338 m.
  - OBSERVED: Exactly one rgbd_cup_pose and one dynamic workflow started after scene setup; no truth bridge or cup_pose_tf_demo started. Dynamic input equals the accepted perception pose and unique exact producer stamp.
  - OBSERVED: Session rgbd-pick-right-exp028-20260826/reset epoch 0 passed preflight. Workflow reached DONE with transition_count=19 and full trace, changing controller trajectories, joint/FK targets, and close/open gripper targets.
  - OBSERVED: Physical truth achieved bilateral unsupported grasp, lifted from z=0.1668549051 to z=0.2248958154, and transported to [-0.0769951678, -0.2462358961, 0.2282904268] with bilateral contact and no table contact. Detach preceded open.
  - OBSERVED: Release ended table-supported at [-0.0778932921, -0.2475248431, 0.1647761029] with zero finger contacts and near-zero velocity. final_xy_error_m=0.0025208466 and final_upright_tilt_rad=0.0032508470 pass; final Planning Scene is detached with pedestal=1, plastic_cup=13, table=1.
  - OBSERVED: Direct inspection of three distinct 1568x862 same-window PNGs shows the right-shifted baseline cup with open gripper, raised bilateral transport beside an empty target, and released cup inside the target with the gripper open above it.
  - OBSERVED: Launch and coordinator naturally exited 0 and all required processes report clean exits. Exact child, domain 206, session/partition process set, tmux, Viewer, and CUA are empty after cleanup.
retained_risk:
  - OBSERVED: Streaming perception fail-closed rejected 110 motion/occlusion frames after the accepted input; none was consumed by the workflow.
  - OBSERVED: ros2_control_node emitted two pal_statistics context-invalid shutdown diagnostics, then exited cleanly; retain as nonfatal shutdown risk.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/acceptance-gates.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/run/full-restart.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/run/full-restart.exit
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/run/capture-coordinator.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/run/capture-coordinator.exit
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/run.d/rgbd-pick-right-exp028-20260826/perception/summary.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/run.d/rgbd-pick-right-exp028-20260826/perception/cup.ply
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/run.d/rgbd-pick-right-exp028-20260826/dynamic/dynamic-execute-manifest.json
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/gui/viewer-baseline.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/gui/viewer-transport.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/gui/viewer-final.png
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-028/post-cleanup.log
conclusion: cup_test_right_5cm has one accepted, countable hardened FULL_RESTART RGB-D-driven physical pick-place with complete numeric, identity, physical, Planning Scene, controller, visual, natural-exit, and cleanup evidence.
decision: KEEP
next_experiment: NONE
```
...
current_hypothesis: All four frozen initial keyframes independently pass under hardened implementation 48349ca7 and exact f19; final repeat verification, independent review, and final evidence inventory remain.
working_tree_status: Task source and exact f19 submodule are clean before this ledger append; canonical main remains clean at b3770360b26fe8f6fac0e19338d250b6f5cab0e7.
owned_processes: NONE; EXP-028 exact child, domain 206, session/partition process set, tmux, Viewer, and CUA are empty.
preserved_processes: Existing unrelated tmux/processes and canonical main were not operated or modified.
confirmed_conclusions:
  - EXP-025 task_start, EXP-026 forward, EXP-027 left, and EXP-028 right are four accepted independent countable FULL_RESTART runs under hardened implementation 48349ca7 and exact f19.
  - Every countable run has RGB-D numeric agreement, exact MuJoCo identity, bilateral unsupported grasp/lift/transport, detached table-supported release, controller/FK/joint evidence, three directly inspected same-session visual frames, natural zero exits, and exact-owned cleanup.
...
open_risks:
  - Nonfatal pal_statistics shutdown diagnostics occurred in all four current runs.
...
```yaml
transition_id: TRANS-EXP-029-RUNNING-001
recorded_at: 2026-08-26T15:53:51+08:00
experiment_id: EXP-029
from: PLANNED
to: RUNNING
source_commit: b1d026da60783e155226a5665e55e2469794bbc7
implementation_commit: 2f1ca1e7c512f50ab4eca4d121d73152ea9ed2df
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
pre_running_observed:
  - OBSERVED: Task source is clean at b1d026da; exact f19 gitlink/submodule/describe and clean canonical main b3770360 are preserved.
  - OBSERVED: Domain 207, exact task-start runtime/runner/Viewer process set, task-owned tmux, exact Viewer title, CUA identity, and every nominal/derived/session evidence identity were empty.
  - OBSERVED: Only the allowed empty evidence parents now exist; production must allocate the session exclusively. Strict window-scope CUA session rgbd-pick-exp029-viewer-20260826 is active with desktop_unlocked=false.
single_variable: Exercise the installed status-preserving runner at the frozen task_start keyframe; perception, policy, geometry, thresholds, helper arguments, and exact f19 dependency are unchanged.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-029/pre-running/isolation-snapshot.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-029/pre-running/cua-start.json
...
```yaml
transition_id: TRANS-EXP-031-RUNNING-001
recorded_at: 2026-08-26T16:07:59+08:00
experiment_id: EXP-031
from: PLANNED
to: RUNNING
source_commit: 26b0f49122daa94d32acbd9fa44231aafa5b224d
implementation_commit: 012420c9d01e2a7d0dae9d834c22dcae28c4ccfb
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
pre_running_observed:
  - OBSERVED: Task source is clean at 26b0f491; exact f19 gitlink/submodule/describe and clean canonical main b3770360 are preserved.
  - OBSERVED: Domain 209, exact forward runtime/runner/Viewer process set, task-owned tmux, exact Viewer title, CUA identity, and every nominal/derived/session evidence identity were empty.
  - OBSERVED: Only allowed empty evidence parents now exist; production must allocate the session exclusively. Strict window-scope CUA session rgbd-pick-exp031-viewer-20260826 is active with desktop_unlocked=false.
single_variable: Change only the frozen initial keyframe from task_start to cup_test_forward_5cm; installed runner, source, overlay, policy, geometry, harness, and gates are unchanged.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-031/pre-running/isolation-snapshot.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-031/pre-running/cua-start.json
...
recorded_at: 2026-08-26T16:11:45+08:00
experiment_id: EXP-032
from: PLANNED
to: RUNNING
source_commit: bf73243c107425b7f2e248f437376cc9d4661818
implementation_commit: 012420c9d01e2a7d0dae9d834c22dcae28c4ccfb
submodule_commit: f19a8cc3af61feccacb22a9f0d16cc972e3b2c08
pre_running_observed:
  - OBSERVED: Task source is clean at bf73243c; exact f19 gitlink/submodule/describe and clean canonical main b3770360 are preserved.
  - OBSERVED: Domain 210, exact left runtime/runner/Viewer process set, task-owned tmux, exact Viewer title, CUA identity, and every nominal/derived/session evidence identity were empty.
  - OBSERVED: Only allowed empty evidence parents now exist; production must allocate the session exclusively. Strict window-scope CUA session rgbd-pick-exp032-viewer-20260826 is active with desktop_unlocked=false.
single_variable: Change only the frozen initial keyframe from cup_test_forward_5cm to cup_test_left_5cm; installed runner, source, overlay, policy, geometry, harness, and gates are unchanged.
evidence:
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-032/pre-running/isolation-snapshot.log
  - /tmp/so101-debug-rgbd-perception-pick-place-20260826/exp-032/pre-running/cua-start.json
