...
## CP-016 — Approved compact scratch parameter and complete source W8 regression

- Plain human "允许" approves CP-015's optional short-process-directory proposal. Added --process-id-chars4..12, default12 unchanged, with shared pre-write width validation/path-budget107 and exclusive-directory collision rejection. Summary records the actual width. No adaptive simulation W8 configuration, scheduling authority, fsync, warning policy or installed identity checks changed. Seven new real layout/parser/path-boundary tests first fail in t170 (7failed31deselected,elapsed0.30s), then complete runner contracts38passed in t171 (elapsed0.23s). Ruff format/check and git diff --check pass.
- t172 initial full Demo W8 is FAILED/launch-contract invalid: wrong monolithic-prefix environment marker contradicts actual release18 isolated prefixes, one existing installed-layout test fails; elapsed86.68s. Remove only that launch marker, retaining actual18 ament closure/source-parent/copied-child audit. t174 fresh fy full source Demo W8 PASS:3135passed1skipped4known detector fork warnings,3136expected/actual node IDs,elapsed90.63s. Full independent Counter/unique-node/JUnit readback agrees; all10 exact-Python NVMe tempfile preflights and EXITED0 ownership records verified. Optional transformers skip remains explicit, no warning silencing/benchmark collection. Five unsafe modules retain the established serial safety lane, other modules run across8file shards.
- t173 initial Teleop orchestration FAILED: all450cases pass but a discovered zero-case test_support.py helper occupies a shard, exits5; elapsed31.03s. Retain immutable original task script/fx result, do not hide exit5. New task-only v2 orchestration uses actual full collected node IDs to identify case-bearing modules before8shard assignment; full collection remains the expected coverage basis, the zero-case helper is explicitly reported. Four real-process/deadline modules retain a serial safety lane. No Demo runner serial-contract change or Teleop test exclusion.
- t175 fresh fz complete strict source Teleop W8 PASS:450passed,0warnings/skip/errors/failures,elapsed31.24s. Independent Counter/unique-node/JUnit readback matches all450cases,10exact-Python tempfile preflights and EXITED0 ownership records. -W error with only the existing exact third-party general_plain_validator_function exemption; no new filters. Source module origins asserted before/after both package gates; children retain copied18 dependencies only in their environment, with no sys.path/import-spec/executable substitution.
- Retained summaries: scratch/fy/summary.json SHAb45c914e9180b71a70c737f7816d0a35d2cef210da249786ca8d9bca6c4082d9; scratch/fz/summary.json SHA1df9ddd04a45221baa697db2a31f2a56d21cf8a74c61173171922350cd32b7da. Exact source subject acbb70250a91230a45cecbbb877167d9a4f6dbad plus recorded seven owned dirty paths unchanged during each gate. This is source regression evidence, NOT clean copied-production or live acceptance. Retain all earlier t164FAILED/t168INVALID/compiled18missing-case evidence; no retarget of release18 binding.
- Inline scoped review under no-subagent handoff verifies default behavior, bounded width validation, creation/verification consistency, collision preservation, module-wise subprocess isolation, exact collection union, child-parent import distinction, unchanged standard warnings/fsync and one missing CMake test registration. Review is not an independent reviewer verdict. Six source/test/CMake files plus ledger are the complete task-owned scope for this local checkpoint. Generic copied Text Agent identity, fresh clean-source copied overlay/compiled49-entry gate, durable restart/recovery/corruption/adaptive/capability/RGB-D/cloud and actual-page fixed/parallel/adaptive/retry/six-layer gates remain open. Original full goal is NOT complete; no push approval inferred from compact-name permission.
- Fresh approved host readback after t175: no relevant test/runtime child except inspection shell/rg, no18117/4173listeners, codex/kimi sessions preserved. No stack/GUI/motion/publication/deletion. MuJoCo submodule e4c0241 remains unchanged clean. ROS_DOMAIN_ID/GZ_PARTITION not_applicable for source gates; EXP-052 not started.
- Retained: sole registered evidence root/all runs. Archived:none. Deletion candidates: used fu..fz scratch, superseded overlays/build intermediates and earlier candidates; none deleted. Next: formal generic copied identity regression/fix, then clean-source installed/package qualification before full simulation acceptance.

```yaml
checkpoint_id: CP-016
source_subject: acbb70250a91230a45cecbbb877167d9a4f6dbad plus six scoped source/test/CMake edits
working_tree_status: six task-owned source/test/CMake files plus this ledger for scoped local commit
owned_processes: NONE; all W8 handles terminal and approved host readback checked
preserved_processes: codex and kimi sessions; all unrelated user processes
next_command: Establish generic copied identity RED regression before fresh installed/live acceptance.
```

## W8 short physical process directory — approved, t170 RED PLANNED

- Plain user response "允许" approves the optional4hex directory parameter proposed at CP-015. This approves W8 tool compatibility only, not renewed publication permission. Existing implementation worktree/source acbb/five task-owned dirty files retained. Use TDD inline; no subagents, default12 remains unchanged, preserve exclusive mkdir/collision rejection, path-budget107, fsync and provenance.
- Add regression coverage for actual short scratch layout creation/collision preservation, CLI default/override, accepted107-byte path/rejected108-byte path and invalid width rejected before writes. Reserve t170 RED fresh scratch/fu/tmp, t171 focused GREEN fresh fv/tmp, then t172 W8 complete ordinary Demo in a new short run id. Exact registered Python tempfile proof required before each pytest process. W8 tests are source/dirty-recorded regression evidence, not clean installed/live admission. Current full ordinary Demo3129 and Teleop450 baseline results predate W8.
- Run the existing eight file shards after its five unsafe modules' serial safety lane; preserve node-ID exact-union comparison and per-process isolated NVMe scratch/ROS/IPC/ownership. Teleop compatibility is not yet established by this Demo-specific runner and must not be omitted or claimed. Broad installed t164 remains failed and generic copied identity/full original live requirements remain open. No push, stack, GUI, motion or deletion.

## CP-015 — Ordinary regression corrections; W8 and installed admission remain open

- Blocking audit: the same explicit W8 short-process-name design approval is still missing across the user-triggered W8 turn and two automatic goal continuations. Latest continuation is not a human answer or renewed publication permission. Current HEAD/dirty paths/runner12hex default revalidated unchanged. Prior continuation made diagnostic progress, but that safe read-only route is now complete; do not repeat it or infer approval. Goal is blocked pending a human decision, not complete. Original full endpoint remains unchanged.
- Current source HEAD acbb70250a91230a45cecbbb877167d9a4f6dbad, branch codex/teleop-expert-validation-web, clean unchanged MuJoCo submodule e4c0241. Four task-owned source/test changes remain uncommitted: resource-fixture namespace/counter isolation, collection child PYTEST_ADDOPTS isolation, registration of the existing backend-result CMake gate, and a real generated-CTest registry regression. This checkpoint records evidence, not a completed W8 qualification or the original17-task endpoint.
- t165 RED2failures/elapsed16.27s; t166 affected complete modules10passed/elapsed19.11s. t167 complete strict source Teleop450passed/elapsed36.70s,exit0,no warning summary,new filters or skips. t169 complete ordinary source Demo3128passed1skipped4known detector-fork warnings/elapsed338.35s,exit0; JUnit3129cases0errors0failures. Skip is optional transformers unavailable. These full source runs predate the user's new W8 instruction and are not represented as W8. All gates retain exact registered Python/fresh NVMe TMPDIR/TMP/TEMP proof, logs, actual exit codes and JUnit; no benchmark collection.
- Release17 seven-package build passed but frozen installed console identity rejected its venv-generated wrapper; retain INVALID qualification. Standard /usr/bin/colcon producer release18 seven-package build passes53.58s, accepted closed binding SHA10fc26d670f42e5b252b53bf37c83be39e96c6a771d3887fff01a222966a82fd, independent copied identity/factory readback315production Python files and seven prefixes. This is identity/factory-only scope, not live acceptance. t151 focused true installed60passed; t162 true installed Teleop449passed. Historical compiled release18 CMake t16348entries448cases passed but omitted backend-result case. New actual CMake configure generates49entries; a fresh clean-source compiled registry/overlay is still required, and release18 binding must not be retargeted.
- t164 broad actual installed Demo remains FAILED:10failed3117passed1skipped4known warnings/elapsed341.70s. Nine generic Text Agent cases fail because runtime.provenance resolves Git from the copied module directory outside a repository; remaining nested collection failure has t165 RED/t166 GREEN source correction. t168 standard-colcon source-origin bootstrap is INVALID before collection: actual colcon restores its own installed prefix, origin assertion rejects it. No source-preload/sys.path rewrite, permissive identity, fake Git metadata, symlink fallback or installed-byte edit is used to turn either gate green.
- New read-only release18-generic-provenance-boundary-audit-001.json SHAbe779227a86e4c6ee07c47eb958993cf5608ba1fdfcfbc874efdf30ab8f31206 independently confirms application/text_agent.py, runtime/provenance.py and cli/text_pick_agent.py each equal copied bytes and Git HEAD bytes. Source-directory Git succeeds at acbb, copied-directory Git exits128. This excludes staleness of those three modules, not all possible installed failures. Correction: Coordinator's outer _provenance validates the complete Demo module tree in addition to five explicit binding artifacts; generic identity does not invoke that verifier. Reuse must preserve that complete source/install/content/cleanliness proof rather than trust caller SO101_SOURCE_COMMIT. Dirty source admission remains rejected.
- Latest user requires W8 Python regression. Existing tools/so101_pytest_gate.py defaults to8, uses exact collection/union and isolated per-process scratch, and retains five unsafe Demo modules in a serial safety lane. Current registered root/scratch/fu/12hex/ipc-response/s reserves115bytes, exceeding Linux107. Proposed optional4hex physical process-name parameter reserves107 at this root; keep default12/exclusive mkdir/collision rejection/path-budget/fsync/provenance. Explicit brainstorming design approval is pending; no runner implementation, t170 or fu creation yet. Runner currently requires Demo serial modules; Teleop W8 compatibility must be established without omitting its full package collection or claiming it ran.
- Original restart/operator-recovery/corruption, qualified adaptive projection/capabilities, RGB-D/cloud evidence, actual-page sequential four/same-four parallel/exact20adaptive/eligible independent FULL_RESTART retry and six-layer acceptance remain open. Historical EXP-051 is INVALID full Web acceptance; EXP-052 not started. ROS_DOMAIN_ID/GZ_PARTITION not_applicable for this read-only/package continuation. Approved host readback shows no relevant runtime/test child, ports18117/4173 absent, codex/kimi sessions preserved. Previously denied publication not retried; no new push authority inferred from internal goal text.
- Retained: all runs/artifacts under /data/work/so101-evidence/moveit-expert-validation-web/20260916-e1701375-a01. Archived:none. Deletion candidates: used scratch through ft, build intermediates and superseded overlays; no evidence deleted. Sole-root external task-ledger.md contains detailed monotonic gate/build records. No new source commit or runtime success claim.

```yaml
checkpoint_id: CP-015
current_hypothesis: Generic installed identity must consume complete validated source/install binding; W8 runner requires bounded path compatibility.
working_tree_status: four task-owned source/test files plus this audit ledger; source HEAD acbb70250a91230a45cecbbb877167d9a4f6dbad
owned_processes: NONE; all gate handles terminal and approved host readback checked
preserved_processes: codex and kimi sessions; all unrelated user processes
next_command: NONE; awaiting explicit W8 short-process-name design approval before implementation
```

## Fresh copied release17 qualification — PLANNED

- Prior checkpoint CP-014 source014bd20ab0c0706e6c0554271973f866d5ea0c3e; preceding turn progress. Current direct host AI-STATION-001, same clean implementation worktree/branch/submodule. Before more feature changes, eliminate the incomplete installed dependency closure that invalidated most full Demo t124 failures and qualify the already implemented real CLI/API composition against a fresh copied install. This does not replace remaining lifecycle/adaptive/live requirements.
- Build only the seven-package closure mujoco_3d_lidar, mujoco_ros2_control_msgs, mujoco_ros2_control_plugins, mujoco_ros2_control, so101_mujoco_support, so101_demo_py, so101_teleop, ROS-only /opt/ros/jazzy underlay, no symlink install/source fallback/mixed overlay. Reserve manifest-source-build/install/log-release17, fresh scratch fa/tmp, exact registered test venv and tempfile proof. Retained local lodepng source is an explicit disconnected dependency; optional LiDAR simulate copy remains disabled, core MuJoCo simulation remains enabled. Do not fetch/install dependencies or mutate /opt.
- After the planning-only commit, record its exact clean source in the external ledger before build. Create a new closed seven-key provenance binding from actual new installed artifact SHA values; never retarget or overwrite release16. Independently check all seven package prefixes, copied module origins, upstream fixed-control composition, version0.1.0 worktree submodule, config/catalog/model boundaries and installed server/layout/startup help. Then run real-process integration, complete source ordinary Demo/Teleop with the correct current install closure, installed/colcon package gates in separately fresh registered scratch. Tests must collect nonzero cases, no benchmark suite, preserve actual warnings/failures and elapsed time. t151 and scratch fb are next after build fa.
- Build/package gate only; ROS_DOMAIN_ID/GZ_PARTITION not applicable, no stack/Worker/Broker/real motion or GUI acceptance. Historical EXP-05179a/release16/server231/Workers181,182,183 remains INVALID full Web acceptance; physical EXP-052 not started. Do not retry previously denied push. Retain all runs/scratch, archived:none, used scratch/build intermediates deletion candidates only; no deletion.
...
- Fixed owner requests now generate independent32-byte random64hex credentials and bind the internal environment to campaign/batch/epoch and the actual batch-root/control/control.sock path. Partial/mismatched bindings fail construction; legacy all-absent requests do not acquire fabricated credentials. Credential-bearing environment/token fields are excluded from dataclass repr; no public API token field is introduced.
- The private store persists the real credential binding atomically with the existing execution-owner INTENT, validates it against the immutable Web batch binding and restores it on real reopen. New fixed_control_bindings and recovery_fences tables contain Web control identity/recovery metadata only, not point outcomes, attempt seals, leases for Workers or a second scheduler. Root0700/DB0600 are enforced before SQLite writes sensitive bindings; the database rejects symlinks and multi-link aliases before chmod. SQLite WAL/FULL/FK integrity semantics remain enabled. Fixed owner ACK must match the original control epoch before the RUNNING update.
- Live fixed Supervisor cancellation proves the recorded leader identity and durable RUNNING fingerprints, then uses the real authenticated CoordinatorControlClient. Stable command identity binds campaign/batch/epoch/reason. Only the upstream public request_stop owns the durable BATCH_STOPPING transition. Missing/mismatched binding, identity or protocol/ACK failures create a durable Web recovery fence and re-raise; lease admission remains unresolved across store reopen. No fixed PID/group, Worker, Broker or Runner signal is added, and the direct fixed process-owner cancel rejection remains intact. Already-exited/no-descendant guard and exact adaptive wrapper cancellation are preserved.
- t126 intended RED:6failed16passed,2.15s,elapsed2.43s,exit1. Before GREEN, corrected an unreachable new-test lookup typo to the existing owned_execution method; do not count that typo as a production regression. t127 intermediate:3failed19passed,10.58s,elapsed10.87s,exit1; all credential/private-storage cases GREEN, remaining failures at old fixed cancel API. The bounded real child endpoints existed and exited naturally. t128 GREEN42passed2.80s,elapsed3.09s,exit0. Tests exercise real store, process owner, non-ROS Coordinator children, fsync journal and Unix client/server; no fake transport, producer seals or physical cleanup qualification.
- t129 intermediate complete strict Teleop:438passed12.24s,elapsed12.60s,exit0. Inline review exposed two additional durable boundaries. t130 RED:2failed42deselected,0.37s,elapsed0.66s,exit1 proves wrong-epoch ACK accepted and hard-linked database reached SQLite after alias chmod. t131 GREEN44passed2.95s,elapsed3.23s,exit0. Final complete strict source Teleop t132:440passed12.13s,elapsed12.49s,exit0,no warning summary; -W error with only the existing exact third-party general_plain_validator_function compatibility exemption. All new scratch eb..eh/tmp exact venv tempfile proofs/logs/JUnit/metadata retained; no benchmark suite collected.
- Review was inline under the authoritative no-subagent handoff, not an independent reviewer verdict. This is a scoped source checkpoint, NOT production physical cancellation or full feature acceptance. The upstream CLI still must consume/remove the credential environment before child launch, start the real fixed endpoint at the actual journal epoch and route cooperative stop through its existing controller/Worker/Broker cleanup composition. STOPPING ACK is not cleanup authorization. Durable recovery API projection/operator recovery, other restart/idempotency/corruption gates, full RGB-D/cloud producer evidence and qualified adaptive projection/capabilities remain open.
- Next: CLI endpoint/cooperative-wait RED tests, then correct-source complete copied overlay/ordinary Demo/installed gates and pending EXP-052. Historical EXP-051 source79a/copied release16 remains INVALID for full Web acceptance; runtime server ROS_DOMAIN_ID231, Worker181/182/183, GZ_PARTITION=not_applicable (MuJoCo). Full Demo t124211failures remains unqualified; no old installed identity is substituted for new source tests.
- All t126..t132 handles terminal. Retained: single registered root and all evidence. Archived:none. Deletion candidates:scratch eb..eh and historical candidates; none deleted. Publication remains unperformed after earlier approval denials; no retry or bypass. Original17-task goal remains active.

```yaml
checkpoint_id: CP-012
last_valid_experiment: EXP-006
current_hypothesis: Wire the upstream CLI fixed endpoint and cooperative-stop observation into the existing safety cleanup composition before a fresh installed physical campaign.
working_tree_status: seven task-owned production credential/control/store/test/ledger paths verified for scoped local commit
owned_processes: NONE; all bounded gate handles terminal
preserved_processes: all unrelated user sessions/processes
next_command: Add real CLI endpoint/cooperative wait RED tests; retain fixed signal rejection and authoritative cleanup gates.
```

## Production fixed-control credential/ownership binding — bounded RED gate

- Starting clean source `edebfeb1d711234e4917bcfe61bf1a1dbce4a0c3`, CP-011. Previous goal turn was progress: real fixed protocol commit and verified source/diagnostic evidence, not full production cancellation. Current host directly ai-station; implementation branch/worktree/submodule unchanged and clean before this entry. Fresh host ps/ss/docker/tmux found no task stack/test/server/browser or4173/18117listener; unrelated codex/kimi preserved.
- Confirmed first boundary: fixed launch only records a predictable digest and fake socket metadata, while Supervisor cancellation still invokes the intentionally rejecting process-owner API. No real durable control binding exists. The new upstream endpoint uses public durable request_stop and never fabricates cleanup; keep that authority.
- Planned t126 RED: prove production owner-request credentials are random and campaign/batch/epoch/socket-bound, store credentials atomically with spawn intent across real reopen in private SQLite, real Supervisor/ExecutionProcessOwner cancellation reaches a real child Coordinator endpoint, and missing control binding enters durable recovery without signalling the child. Reserve new scratch/eb/tmp with exact venv tempfile proof. Only bounded non-ROS children, real journal/store/Unix transport; no simulation or physical qualification.
- Next GREEN will wire authenticated binding/precise owner verification/recovery fencing, not weaken ExecutionProcessOwner.request_cancel. CLI cooperative-stop/cleanup integration is the next separate boundary before a fresh copied installed release/package gate and pending EXP-052. Full Demo t124 remains unqualified; preserve its missing-install-index and unconfirmed domain-claim evidence. Historical runtime remains79a/release16, server domain231/Worker181,182,183/GZ_PARTITION not_applicable. No publication retry after earlier denial.

## CP-011 — Real fixed control protocol, not yet production cancellation

- Starting clean source: `7c8d61e802013deb787d5c5cc9502f0ca347b8ff`. Task-owned changes are the real upstream fixed control endpoint, Teleop transport integration/safety regression tests and this ledger. No new installed release or physical campaign; EXP-052 remains pending.
- `so101_demo.parallel_batch.web_control.FixedCoordinatorControlServer` owns a0700-parent/0600 Unix endpoint inside the actual fixed BatchRequest evidence root and bound Coordinator epoch. It authenticates same-UID peers and a64hex token, validates the closed canonical frame/request identity/hash, rejects malformed operations without poisoning the accept loop, and binds duplicate command IDs to the same request. CANCEL_BATCH calls only public BatchCoordinator.request_stop, which fsyncs the existing BATCH_STOPPING transition before ACK. New grants/reset/inference/action are fenced by the upstream owner, not by a second Teleop scheduler.
- Socket addressing follows existing upstream IPC's pinned O_DIRECTORY/O_NOFOLLOW parent FD and /proc/self/fd address. The actual socket remains inside the long durable batch root; no relocated evidence, abstract sockets, symlink overlay or relaxed root constraint. Close unlinks only the recorded socket inode through its retained directory FD and is idempotent; an outside hard-link alias and a foreign replacement survive. Actual post-bind chmod failure cleans only the just-bound socket. Adaptive PoolRequest cannot open this fixed endpoint.
- Teleop client now rejects bool/float schema-version/epoch replies and uses pinned-directory connect plus SHUT_WR request half-close. The latter was missed by the synthetic transport and exposed by the real upstream frame reader. Tests include real client -> real server -> real BatchCoordinator/CoordinatorJournal with no injected transport, result verifier or seal discovery. STOPPING/ACK is explicitly not a physical safety/cleanup receipt. Endpoint descendant/domain facts remain false and cleanup receipt absent until the production cleanup composition is wired.
- RED/GREEN history: t1085fail14pass ->t10919pass; t11016setup errors INVALID ->t11116executable missing-feature failures ->t11216pass; t1133fail37pass includes one INVALID wrong fixture path ->t1144intendedfail36pass ->t11540pass; t1161fail21pass and t1172fail21deselected ->final t11843pass in3.60s,elapsed3.89s,exit0,no warning summary. Exact scratch dk..du interpreter tempfile proofs and all logs/JUnit/metadata retained.
- Complete strict source Teleop t119:432passed in10.52s,elapsed10.88s,exit0,no warning summary; only the existing exact external general_plain_validator_function compatibility warning exempted. Scratch/dv/tmp exact venv proof retained. No Web code changed; no new Web/browser/live qualification claimed.
- Ordinary Demo gates are NOT green: t120 collection stopped before tests due missing so101_mujoco_support; t121 fail-closed executable/setup preflight rejected wrong package-level path before scratch creation; t122 collection stopped at system0.0.3 message package lacking FreeJointState; t123 corrected message closure but lacked the repository tools namespace. These INVALID environment gates and unused/used scratch are retained, not counted as source RED.
- t124 verified current source Demo import at src/so101_demo_py/src/__init__.py, tools namespace, existing release16 message packages and fresh scratch/dz/tmp, then ran exactly src/so101_demo_py/test (no benchmark). It terminated211failed/2902passed/1skipped/4known detector-fork warnings in353.37s,elapsed354.73s,exit1.206failure texts directly lack Demo's installed ament index;4other failures concern bundle/prefix or wrapper subprocess environment, while the concurrent domain-claims rejection trigger remains unconfirmed. All23new endpoint cases passed even in that full run. This does not qualify the full ordinary or fresh installed package gate. t125 isolated characterization/contracts19passed,elapsed0.42s,exit0; it does not replace the full gate.
- Inline review per authoritative no-subagent handoff: real transport, real durable upstream owner, exact frame/credential identity and directory/inode cleanup boundaries were checked, and the exposed lifecycle/mode errors were repaired through RED/GREEN. No Worker/Broker/Runner signalling or alternate execution/result authority was added. This component is suitable for a scoped local commit, NOT ready for complete feature acceptance or merge.
- Remaining first-bad production gate: Supervisor still has no durable real credential binding and its active fixed cancel still reaches FIXED_CANCEL_REQUIRES_CONTROL_SOCKET; the CLI must start this endpoint and route cooperative stop through its existing Worker/controller/Broker shutdown/cleanup path. Keep the rejecting gate until authentic composition is proven. Then build a fresh complete copied release and repeat ordinary/installed gates before EXP-052. Durable restart/idempotency/corruption fencing, qualified adaptive projection/capabilities, full producer RGB-D/cloud artifacts, actual-page sequential/same-four parallel/exact20adaptive/conditional retry and all-layer visual/cleanup gates remain open.
- Runtime provenance remains historical EXP-051 source79a/release16, server ROS_DOMAIN_ID231, Worker domains181/182/183, GZ_PARTITION=not_applicable (MuJoCo). It remains INVALID for full Web acceptance and is not retroactively repaired by these source tests. Publication remains unperformed after prior approval denial; no retry/bypass.
- All test handles terminal; fresh host ps/ss/docker readback shows no task motion/server/browser/pytest or4173/18117listener. Unrelated codex/kimi preserved. Retained: single registered root and all new/existing logs/JUnit/seals/releases. Archived:none. Deletion candidates:scratch dk..ea, including environment-only/failed-collection trees, plus historical scratch/superseded overlays. No evidence deleted.

```yaml
checkpoint_id: CP-011
last_valid_experiment: EXP-006
current_hypothesis: Wire the real fixed protocol into Supervisor durable credentials and the upstream CLI's existing cooperative shutdown composition before any new physical campaign.
working_tree_status: five task-owned endpoint/transport/test/ledger paths prepared for scoped local commit
owned_processes: NONE; all gate handles terminal
preserved_processes: all unrelated user sessions/processes
next_command: Add production credential-binding and CLI cooperative-stop RED tests; do not weaken fixed process-owner cancellation rejection or invent cleanup facts.
```

## Authenticated fixed control — bounded transport RED gate

- Correction: t110's missing feature surfaced as16fixture setup errors, not executable RED; retained as INVALID gate evidence. t111 moved endpoint entry into actual test bodies after real owner creation:16intended missing-endpoint failures,elapsed0.66s,exit1. t112 GREEN16passed,elapsed2.91s,exit0.
- t113 retained3fails37passes: two malformed-operation types poisoned the accept loop; one new cross-package test had a wrong fixture path and is INVALID for that assertion. t114 corrected the path and added an independently verified hard-linked socket alias outside the bound directory:4intended failures36passes,elapsed8.16s,exit1. These prove operation-type rejection, duplicate-close directory confinement and the real client's missing request half-close. t115 GREEN40passed,elapsed3.67s,exit0.
- t116 RED1failed21passed,elapsed3.16s,exit1: a real bind followed by injected chmod failure left the owned socket behind. t117 RED2failed21deselected,elapsed0.36s,exit1 adds rejection of an adaptive PoolRequest at the fixed control endpoint. Ownership is now captured immediately after bind and before permission changes; close is pinned/idempotent, and only fixed BatchRequest is accepted.
- Final focused t118:43passed,elapsed3.89s,exit0,no warning summary. It includes actual Teleop client -> real upstream endpoint -> real BatchCoordinator/CoordinatorJournal, with no injected transport, no seal discovery/result verification or motion. STOPPING is explicitly not cleanup authorization; independent descendant/domain facts remain false and cleanup receipt remains absent.
- Next complete gates t119 Teleop and t120 ordinary Demo will use separate fresh scratch/dv/tmp and scratch/dw/tmp, exact venv tempfile proofs, explicit ordinary test directories and retained JUnit/log/elapsed evidence. No benchmark collection. Production Supervisor credentials/startup and CLI cooperative cleanup integration, installed gates and EXP-052 remain open; this standalone endpoint does not qualify live cancellation.
- t108 reached the intended boundaries:5failed/14passed,elapsed2.60s,exit1. Four cases showed bool/float identity coercion; the real long-path peer failed at AF_UNIX path too long. Its bounded peer thread terminated without any motion. t109 focused GREEN:19passed,elapsed0.55s,exit0,no warnings; scratch/dl/tmp exact interpreter resolution verified.
- Next t110 RED adds the missing upstream fixed Coordinator endpoint contract. Tests will use a real fsync-backed CoordinatorJournal and BatchCoordinator plus actual Unix transport, assert durable stop/new-lease fencing and idempotent duplicate cancellation, and prove malformed/token/identity/frame requests do not mutate the Coordinator. There is no simulation, controller or cleanup qualification in these offline cases. Scratch/dm/tmp is reserved for this fresh gate.
- Starting clean source: `7c8d61e802013deb787d5c5cc9502f0ca347b8ff`; CP-010 is the latest trusted checkpoint. The preceding status-only turn made no implementation progress. EXP-052 remains pending; no new installed release or physical campaign is started.
- Confirmed first boundary: Supervisor fixed cancellation still delegates to the deliberately rejecting process-owner API; its launch request uses a predictable campaign/batch digest rather than a real peer credential. The authenticated client has no production composition or matching upstream Web endpoint.
- Before wiring that endpoint, t108 RED will exercise the actual client against a real private Unix socket at a path longer than Linux sockaddr_un permits, and reject bool/float schema-version and epoch replies. The upstream AuthenticatedUnixServer/UnixRpcClient already pin the real socket parent with O_DIRECTORY/O_NOFOLLOW and address it through /proc/self/fd; this preserves the approved socket-within-batch-root contract without relocating evidence or loosening bindings.
- Transport tests use non-ROS peers only, not a qualified Coordinator or fabricated cleanup authority. Exact NVMe scratch/dk/tmp and test venv tempfile resolution must be proven before pytest. Retain logs/JUnit/metadata and classify scratch as a deletion candidate only.
- Fresh host read-only ps/ss/docker/tmux audit found no task motion/server/browser or4173/18117listener; unrelated codex/kimi sessions preserved. Historical runtime provenance remains EXP-051 source79a/copied release16, server domain231, Worker domains181/182/183, GZ_PARTITION=not_applicable. Publication remains unpushed after prior denial, with no retry or alternate transport.
...
current_commit: acbb70250a91230a45cecbbb877167d9a4f6dbad
