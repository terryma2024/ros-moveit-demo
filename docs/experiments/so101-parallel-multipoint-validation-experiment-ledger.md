...
observed:
  - The fresh four-package build passed in 2.34 s. The complete ordinary so101_demo_py suite passed 2841 tests with zero errors, failures or skips in 91.68 s; benchmark_test was not collected.
  - Production provenance binds clean source commit cebdf182b07e8fcf2ea0cb5f288aa0073538bd95, equal source/install module-tree hash 8be223de576ea2bc0401a9d3060a2d2cff7dfe66e749a7d37d380484ada46c48 and equal host/image source hash f1737b9dab782e99fa458006b05fba978157459f5b487a52c5da56d32c5e5224.
  - Immutable image sha256:946ef501ea8a398dcfa1c2eb33c7264859d94a71931c42bc3d74b215e81ca9d3 rebuilt in 13.37 s. Frozen P01 YOLO and Grounded-SAM each returned one QUALIFIED candidate in the 9.40 s smoke.
  - Post-smoke cleanup found no related process, running container or GPU compute application.
conclusion: VALID; EXP-128 is fully package-, install-, image-, model-, provenance- and cleanup-qualified for live F2 repetition.
evidence:
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-colcon-build.log sha256=48cfe194a7b317202cb61ca825caa1432b6d9c07bb66206b285defae78c98368
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-colcon-build.time sha256=7a3d132da55fcc65414ec74639add8bcb2a5490f71059a2bd50a6fb2db7c36b8
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-colcon-test.log sha256=baa421484017a6fe3a1ffc953540345512b7aea7e68c2318dedcb86f0174867f
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-colcon-test.time sha256=f550ceefb37c8c9a320d9e8bd166ffec8e145c967daa2a5e106e0bcf4aa36374
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-colcon-test-result.log sha256=245c80f9c6a64f29218ab901fe751aaaaf28681f17f2cde7fa5c8a38b7174ba9
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-image-build.log sha256=34485d54fac4ec732c44dd4f1b5f76d6552078e3473a8bf2265f22ebcad70c72
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-image-build.time sha256=9f1d75d36be2b350e7ceb8942639c1304055ac90cfcfd759dc96bdf37bf709f9
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-image-build.json sha256=f7e8cbce42f6d8365c49149375fb44235edfac70b323fbeddb985a65ff8ffe76
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-model-smoke.log sha256=6b5e506dd2696c45bff1da261fc602639a6dfded53992214dedab3e8d8a2559e
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-model-smoke.time sha256=003d2e2b78c9c425d8f3ab1398374dfbefd1b7ff1894ab7ea1ae0b81257a7b00
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-smoke-admission.json sha256=e444f49722bde61d52570a5c721d61028b00febf6f554dc39bcc03abbf729204
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-production-provenance.json sha256=54af8ddb80ba4d3a1e2923cb6b7581c3cc5865b88541821d94ff3a7743b7fb48
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp129-cleanup-audit.json sha256=27b575ecbbc39d8172d555b9d364e4d44d5bf7f2df740292d288886de61fea3f
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/task14-remediation-129-smoke/ipc/.model-ready.json sha256=abbffa6b779d4e251d66dec19bbbb1acc8570d40714f0b9eeb74f038e5c9a0e7
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/task14-remediation-129-smoke/ipc/smoke.json sha256=e1eb8e12b4e62644241a225733737fb8a4adf031d853d486f60f40a60ef0d2b4
deletion_candidates:
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/scratch/p129b
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/scratch/p129t
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/scratch/p129i
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/scratch/p129s
...
current_hypothesis: The fully qualified runtime-generation binding will let the same two Workers consume generation-2 responses after exact Broker recovery instead of exhausting K on BROKER_GENERATION_CHANGED.
working_tree_status: EXP-129 result and EXP-130 preregistration are ledger-only; source/install/image are clean and provenance-bound.
owned_processes: NONE
preserved_processes: Existing unrelated stopped containers only.
confirmed_conclusions:
  - EXP-128 passes the complete package and immutable dual-model qualification gates.
open_risks:
  - Live F2 must still prove post-recovery Worker policy binding and useful continuation.
next_command: Commit CP-116, persist/read back and syntax-check EXP-130 scripts, then repeat the exact four-point mirror-corruption fault with the EXP-129 image.
```

## EXP-130 — Runtime-rebound live Broker recovery
...
lifecycle: ISOLATED_STACK
batch_id: f2-130
evidence_root: /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/f2-130
worker_count: 2
max_points_per_worker: 3
selection: task_start,cup_test_forward_5cm,cup_test_left_5cm,cup_test_right_5cm
...
status_history:
  - status: PLANNED
    at: 2026-09-13T13:04:49+08:00
  - status: RUNNING
    at: 2026-09-13T13:06:00+08:00
  - status: VALID
    at: 2026-09-13T15:46:42+08:00
...
retention_rule: Retain all command, Broker, Worker, journal, physical, visual and cleanup evidence; delete nothing without explicit authorization.
observed:
  - The immutable execute command exited 0 in 909.59 s. The aggregate contains exactly 20 catalog points, every point is terminal PASSED with attempts=1, and coverage_complete, execution_complete and qualification_passed are true with POINTS_COMPLETE.
  - Worker-01 and worker-02 each consumed exactly 10 leases and each produced 10 PASSED point results plus the expected terminal NO_POINT record. No Worker result has a failure boundary, message or type.
  - Direct fresh inspection of all 20 terminal RGB files showed the cup upright inside each red target and the arm clear at terminal state. A 20-entry checksum manifest was independently read back with sha256sum -c and every image returned OK.
  - Each PASSED seal contains attempt result, workspace identity, initial/terminal RGB, pose acceptance, dynamic execution/reachability and depth/TF/physical evidence. The physical records are unpaused and bind unique simulation-session evidence to their attempts.
  - Every cleanup-gates component passed. The exact Broker container ID, every recorded owned PID, all full-133 processes and all related running containers were absent on direct readback.
conclusion: VALID; the current immutable source/image satisfies the final two-Worker complete 20-point physical qualification contract with exact once-only coverage and cleanup.
evidence:
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/command-133.log sha256=ce2ca4f13d93aa9cbfa82779a0e364b3db959fa0f37b63229c4cdbc4fa849c86
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/command-133.time sha256=ac55fc55f755a927bc323e452992f2dbe02f01001aa76b502a6a1e4ce9d81ec9
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/command-133.exit sha256=9a271f2a916b0b6ee6cecb2426f0b3206ef074578be55d9bc94f6f3fe3ab86aa
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/run-exp133.zsh sha256=891eaef59ac566f8cdd9343a364611e9a7ca79e0a6b936e867bf61b196494323
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/MUJOCO_LOG-EXP133.txt sha256=097bd1784d1fe5d88e636fae15aa8fac70d5bd3cae58adc36eccdd81d7e6a539
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/full-133/coordinator/aggregate_results.json sha256=636c452e3aea4841eacce136491f2f77e974f9453a192953f17df8dee270931b
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/full-133/workers/worker-01/worker-run-results.json sha256=dfba98d62e6e46fc2e737b0eaf0929a600834b0bf06a614504da7ff5635029ad
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/full-133/workers/worker-02/worker-run-results.json sha256=487427f97cebf87628a153638e4b717192256a432671cf068df5a3793acce612
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/full-133/cleanup-gates.json sha256=ee75c991fb6eb1700d69f21328837cdb03afb2dc0c5c0f65d1631bbc67d9e92d
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp133-terminal-rgb.sha256 sha256=8d0ff6cb349cb4d7518675770d017b24dabedf035a46e09cc0386cbdf3c6e97a
...
observed:
  - Commit 44feaf77c6d29f12c0de15dd7f57ccaea6636683 rebuilt so101_demo_py successfully in 1.89 s. The five changed installed modules byte-match their source SHA256 values and ros2 pkg prefix resolves to the isolated worktree overlay.
  - The first ordinary-test invocation was INVALID before collection because the registered Grounded-SAM site-packages binding was omitted, so torch was unavailable; it is retained and not counted as a candidate failure.
  - The corrected fresh invocation bound both the worktree libexec PATH and /data/work/venvs/so101-grounded-sam Python packages, verified /usr/bin/python3 tempfile resolution under the new NVMe scratch, and passed all 2865 ordinary tests in 92.12 s with four pre-existing fork warnings and no benchmark collection.
conclusion: VALID; the EXP-134 source is installed and complete-package qualified. The immutable Broker image and both frozen model smokes must now be rebuilt from the same commit before live execute remediation.
evidence:
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp135-build.log sha256=ef5b521c9418f9ef2ea0a87d00009a7996fbfadb9402964cdfa8d073e40a56a2
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp135-build.time sha256=0f0367ab6b2f08274a48096b7ccc7e5958e4e55bce1b0e334ab4ec3c71ab0c38
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp135-installed-provenance.log sha256=3da3f51b0fbe939caf6939d1e03cb166811eb23141e15dad70e96f83b55fbc79
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp135-complete-ordinary.log sha256=995603934ac568d8b71a17d8a3fe8db937c647d37f17f1318e7ac28a2a7375a5
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp135-complete-ordinary.time sha256=1de881e1873a01d0403b82db6a6264d3fc707fa5bddac2854414c5d4e4fd0f3b
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp135-installed-provenance2.log sha256=4811a9c7cf222874371754a8be543fc8d74082e241fefa84550e2cad2dbf4c36
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp135-complete-ordinary2.log sha256=3dfadbe6554f193edf15c33f1430f9fa85579726afa3944836e201c2f9716c63
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/reports/exp135-complete-ordinary2.time sha256=0808ca097bee434cd186d3935513e40d94a88f6270ecf6b72e0571b726305d7d
deletion_candidates:
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/scratch/e135
  - /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1/scratch/e135b
decision: REBUILD_IMMUTABLE_BROKER_AND_SMOKE_BOTH_MODELS
next_experiment: EXP-136
```

```yaml
checkpoint_id: CP-123
last_valid_experiment: EXP-135
current_hypothesis: A source-hash-bound rebuild of the frozen Broker image will preserve both model outputs and bind live runs to commit 44feaf77c without changing model weights, dependency pins or detector thresholds.
working_tree_status: Only the EXP-135 result and EXP-136 preregistration are uncommitted; source, installed modules and all ordinary tests agree.
owned_processes: NONE
preserved_processes: Existing unrelated stopped containers only.
confirmed_conclusions:
  - The new dynamic semantics, producer receipts and resume namespace admission pass all 2865 ordinary tests.
  - Installed source provenance is exact for all changed runtime files.
open_risks:
  - The currently tagged Broker image still carries pre-EXP-134 source provenance.
  - Active-goal heartbeat cancellation and post-stop multi-layer evidence remain unproven live.
next_command: Commit CP-123 after the mandatory EXP-045 hash gate, then build a new immutable Broker image, smoke both frozen models and audit cleanup.
```

## EXP-136 — Immutable Broker rebuild and dual-model smoke
...
success_criteria: Host/image source SHA256 agree; immutable image ID is read back; both frozen models return QUALIFIED on the retained smoke image; no related running process, container or GPU task remains.
failure_criteria: Build/provenance/model/cleanup failure, mutable image identity, source mismatch, fallback or model-output regression.
invalid_criteria: Pre-existing output/root, wrong source commit, changed model/input, GPU admission failure unrelated to candidate or uncontrolled background stack.
evidence_root: /data/work/so101-evidence/parallel-multipoint-validation/20260912-v1
