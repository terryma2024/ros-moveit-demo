...
## EXP-129 — VALID FULL_RESTART success

```yaml
experiment_id: EXP-129
recorded_at: 2026-08-12T22:53:05+08:00
status: VALID
behavioral_result: SUCCESS
...
phase_maximum_normal_force_n:
  contact_hold: 0.6060929187611249
  micro_lift: 0.6061013364855292
  policy_lift_waypoint1: 0.774876082094659
  remaining_lift: 0.7750797150784496
  transport: 4.982986824474829
  descend: 4.783932381405291
  place_alignment: 4.497177699157209
  release_retreat: 3.4766734127699293
  released_static_final: 0.15105951830495978
physical_outcome:
  primary_failure: null
  final_xyz_m: [-0.0792916959281965, -0.2481718428047334, 0.1654924856311975]
  final_upright_tilt_rad: 0.017432376066860933
  maximum_linear_speed_m_s: 0.0
  maximum_angular_speed_rad_s: 0.000008603189426505625
  support_contact: true
  gripper_contact: false
  moveit_attached: false
  world_object_synchronized: true
...
transport_raw_evidence:
  chunk_count: 744
  sample_count: 3720
  first_physics_step: 26306
  last_physics_step: 30025
  physics_timestep_s: 0.002
  lossless: true
  run_index_sha256: 79ffb91ffe2846b2d5be9d043913846f5859885d3f4db189356d2f5aeab0ec60
visual_acceptance:
  passed: true
...
shutdown:
  ...
  fatal_signal: false
  process_died: false
  domain_201_nodes_after_stop: NONE
  port_8041_listener_after_stop: NONE
  tmux_session_after_stop: NONE
  owned_process_residue: NONE
artifacts:
  ...
  visual_verdict_sha256: 5f8a75c2c47f3b7d008758131000befff2514fa0ceca97ca2d67888738a66d65
decision: KEEP VALID success; continue only to EXP-130 after a fresh full preflight and RUNNING commit.
next_experiment: EXP-130
```

## Checkpoint MNT-CP-046 — EXP-129 valid and clean

```yaml
checkpoint_id: MNT-CP-046
recorded_at: 2026-08-12T22:53:05+08:00
last_valid_experiment: EXP-129
batch_id: MNT-Q-EXP126-130
batch_status: AUTHORIZED_RUNNING
consecutive_valid_successes: 4
counted_successes: [EXP-126_BY_USER_VISUAL_WAIVER, EXP-127, EXP-128, EXP-129]
waiver_scope: EXP-126_ONLY
owned_processes: NONE
protected_state:
  src_so101_gazebo_demo_py_diff: NONE
  preserved_untracked_user_files:
    ...
    - docs/experiments/so101-mujoco-ros2-migration-experiment-summary.md
next_experiment: EXP-130
next_command: Run the complete EXP-130 preflight, transition EXP-130 from PLANNED to RUNNING in the ledger, commit the transition, and execute its preregistered command exactly once.
```

## Checkpoint MNT-CP-047 — EXP-130 RUNNING transition

```yaml
checkpoint_id: MNT-CP-047
recorded_at: 2026-08-12T22:54:24+08:00
experiment_id: EXP-130
status_transition: PLANNED -> RUNNING
prior_experiment: EXP-129
consecutive_successes_before_run: 4
waiver_inherited: false
preregistered_identity:
  simulation_session_id: MNT-Q-EXP130-full-01
  ros_domain_id: 202
...
reset_transactions: 1
retry_count: 0
pre_run_result_commit: d4b1c00ccead4b3403753b5d5e936938a603ed9a
provenance:
  fork_local_origin_main_and_remote_tag_peel: 738e304551b4ea6db020b466086a13db71b65607
  fork_local_vs_origin_main: {ahead: 0, behind: 0}
  fork_status: CLEAN
...
preflight:
  root_status: Exactly the two protected untracked documents; index and all other tracked paths clean.
  protected_gazebo_status: ZERO_STATUS_AND_DIFF
  domain_202_nodes: NONE
  port_8042_listener: NONE
  tmux_session_so101_mnt_q_exp130: ABSENT
  evidence_root: ABSENT
  relevant_processes: NONE
  codex_cua: IDLE_AT_ZSH_PROMPT
  result: EXP130_PREFLIGHT_PASS
visual_acceptance:
  required_sequence: snapshot -> action -> fresh snapshot
  persisted_png_required: true
  independent_png_decode_before_acceptance: true
...
## EXP-128 — VALID FULL_RESTART success

```yaml
experiment_id: EXP-128
recorded_at: 2026-08-12T22:45:53+08:00
status: VALID
behavioral_result: SUCCESS
...
workflow:
  ...
  phase_exit_codes: ALL_ZERO
phase_maximum_normal_force_n:
  contact_hold: 0.6035570268720367
  micro_lift: 0.6035596066317152
  policy_lift_waypoint1: 0.770249905945176
  remaining_lift: 0.7706751108137844
  transport: 4.913286473595916
  descend: 4.773447924276285
  place_alignment: 5.156712797643884
  release_retreat: 4.468524376644462
  released_static_final: 0.2326773158056082
physical_outcome:
  primary_failure: null
  final_xyz_m: [-0.0781694718742764, -0.2475305265286221, 0.1647497292214586]
  final_upright_tilt_rad: 0.002588650646530664
  maximum_linear_speed_m_s: 0.0
  maximum_angular_speed_rad_s: 0.0
  support_contact: true
  gripper_contact: false
...
transport_raw_evidence:
  chunk_count: 743
  sample_count: 3715
  first_physics_step: 24366
  last_physics_step: 28080
  physics_timestep_s: 0.002
  lossless: true
  run_index_sha256: f8e3f043529be7eb8a69fd54a96594fdd17c7e9440bfe8bd9d540d1e812597a7
visual_acceptance:
  passed: true
  required_claims_all_true: true
...
shutdown:
  ...
  fatal_signal: false
  process_died: false
  domain_200_nodes_after_stop: NONE
  port_8040_listener_after_stop: NONE
  tmux_session_after_stop: NONE
  owned_process_residue: NONE
artifacts:
  ...
  visual_verdict_sha256: 4eb35f210c122c59bd46e53176730685df747ad535fc257d7e1e15623a5f19d8
decision: KEEP VALID success; continue only to EXP-129 after a fresh full preflight and RUNNING commit.
next_experiment: EXP-129
```

## Checkpoint MNT-CP-044 — EXP-128 valid and clean

```yaml
checkpoint_id: MNT-CP-044
recorded_at: 2026-08-12T22:45:53+08:00
last_valid_experiment: EXP-128
batch_id: MNT-Q-EXP126-130
batch_status: AUTHORIZED_RUNNING
consecutive_valid_successes: 3
counted_successes: [EXP-126_BY_USER_VISUAL_WAIVER, EXP-127, EXP-128]
waiver_scope: EXP-126_ONLY
owned_processes: NONE
protected_state:
  src_so101_gazebo_demo_py_diff: NONE
...
## Checkpoint MNT-CP-043 — EXP-128 RUNNING transition

```yaml
checkpoint_id: MNT-CP-043
recorded_at: 2026-08-12T22:39:10+08:00
experiment_id: EXP-128
status_transition: PLANNED -> RUNNING
prior_experiment: EXP-127
consecutive_successes_before_run: 2
waiver_inherited: false
preregistered_identity:
  simulation_session_id: MNT-Q-EXP128-full-01
  ros_domain_id: 200
...
reset_transactions: 1
retry_count: 0
pre_run_result_commit: 32c5c8b0ce2c781866533734d4a0226689d5b7f4
provenance:
  fork_local_origin_main_and_remote_tag_peel: 738e304551b4ea6db020b466086a13db71b65607
  fork_local_vs_origin_main: {ahead: 0, behind: 0}
  fork_status: CLEAN
...
preflight:
  root_status: Exactly the two protected untracked documents; index and all other tracked paths clean.
  protected_gazebo_status: ZERO_STATUS_AND_DIFF
  domain_200_nodes: NONE
  port_8040_listener: NONE
  tmux_session_so101_mnt_q_exp128: ABSENT
  evidence_root: ABSENT
  relevant_processes: NONE
  codex_cua: IDLE_AT_ZSH_PROMPT
