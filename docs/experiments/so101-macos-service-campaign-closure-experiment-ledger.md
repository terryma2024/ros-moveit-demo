...
## CP-MSC-REMEDIATION-T11-W2-LIVE: the campaign writes files as the clock ticks

```yaml
checkpoint_id: CP-MSC-REMEDIATION-T11-W2-LIVE
recorded_at: 2026-09-23T17:10:00+0800
carried_by: the local commit that adds this entry (parent 9489ab48)
window: remediation/windows/w2-20260922T191707Z-53004/
status: measured live; five points remain
```

A liveness measurement rather than an inference, taken with the clock and the filesystem in the same
breath:

```text
clock               03:29:34
newest three files  03:29:34, 03:29:34, 03:29:35
files written       last 2 minutes: 60      last 10 minutes: 270
station processes   1:23 and 0:34 old  (stations cycle per attempt, as the profile requires)
projection          RUNNING, sequence 82, 14 PASSED / 5 UNRUN / 1 FAILED
```
