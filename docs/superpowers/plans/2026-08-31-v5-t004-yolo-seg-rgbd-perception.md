...
- [ ] **Step 1: 写 candidate/batch 的失败测试**
...
- [ ] **Step 4: 运行 contracts GREEN**

Run: same command as Step 2.

Expected: all collected tests pass.

- [ ] **Step 5: 写 0/1/2+ 选择器 RED 测试**
...
- [ ] **Step 6: 运行 selector RED，随后实现最小选择器并跑 GREEN**
...
- [ ] **Step 1: 写 hash/device/转换 RED 测试**
...
- [ ] **Step 4: 实现延迟导入的 `YoloSegDetector`**
...
- [ ] **Step 5: 运行 GREEN 与 import-boundary 回归**
...
- [ ] **Step 1: 写 mask 反投影、尺寸/stamp、几何 RED 测试**
...
- [ ] **Step 3: 抽取 mask point-cloud helper**
...
- [ ] **Step 4: 实现 instance 内离群点清理和 world 几何门禁**
...
- [ ] **Step 1: 写 fake detector 全流 RED 测试**
...
- [ ] **Step 1: 写 CLI/ROS/launch RED tests**
...
- [ ] **Step 1: 写 seed/split/object-ID RED 测试**
...
- [ ] **Step 3: 实现 fixture 与 Python MuJoCo renderer**
...
- [ ] **Step 4: 实现 800/200/200 数据集和 manifest**
...
- [ ] **Step 5: 运行 GREEN 与 12 样本 smoke generation**
...
- [ ] **Step 7: 运行 package tests 并提交可提交配置**
...
- [ ] **Step 2: 每次验证 RGB-D payload 与 installed provenance**
...
- [ ] **Step 1: 先做 launch contract RED/GREEN**
...
- [ ] **Step 2: 为 macOS 与 Linux 首次 execute 预登记实验**
...
- [ ] **Step 1: fresh package verification**
