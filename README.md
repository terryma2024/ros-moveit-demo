...
[`docs/pick-place-architecture.md`](docs/pick-place-architecture.md)；运行模式、参数和
安全操作见 [`docs/pick-place-launch-parameters.md`](docs/pick-place-launch-parameters.md)。
