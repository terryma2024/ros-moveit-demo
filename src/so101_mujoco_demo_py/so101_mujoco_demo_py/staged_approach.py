...
from so101_mujoco_demo_py.motion.executor import MoveItExecutionClient, make_execute_goal
...
from so101_mujoco_demo_py.scene_setup import scene_matches_task_geometry
...
def _default_policy_path() -> Path:
    ...
    return (
        Path(get_package_share_directory("so101_mujoco_demo_py"))
