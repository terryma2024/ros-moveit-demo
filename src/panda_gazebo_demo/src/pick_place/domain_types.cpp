...
const char * toString(State state) noexcept
{
  switch (state) {
    ...
    case State::ATTACH_GAZEBO: return "ATTACH_GAZEBO";
    case State::ATTACH_MOVEIT: return "ATTACH_MOVEIT";
    case State::LIFT: return "LIFT";
    case State::MOVE_ABOVE_PLACE: return "MOVE_ABOVE_PLACE";
    case State::DESCEND_TO_PLACE: return "DESCEND_TO_PLACE";
    case State::OPEN_GRIPPER: return "OPEN_GRIPPER";
    case State::DETACH_GAZEBO: return "DETACH_GAZEBO";
    ...
    case State::RECOVER_SYNC_WORLD_OBJECT: return "RECOVER_SYNC_WORLD_OBJECT";
    case State::RECOVER_RETREAT: return "RECOVER_RETREAT";
...
const char * toString(RunStatus status) noexcept
{
  switch (status) {
    ...
    case RunStatus::PLAN_ONLY_COMPLETE: return "PLAN_ONLY_COMPLETE";
    case RunStatus::CHECKPOINT_COMPLETE: return "CHECKPOINT_COMPLETE";
...
{
  switch (mode) {
    case RunMode::DRY_RUN: return "dry_run";
    case RunMode::PLAN_ONLY: return "plan_only";
    case RunMode::EXECUTE: return "execute";
  }
  return "unknown";
}
...
{
  if (value == "dry_run") {return RunMode::DRY_RUN;}
  if (value == "plan_only") {return RunMode::PLAN_ONLY;}
  if (value == "execute") {return RunMode::EXECUTE;}
  return std::nullopt;
}
