...
private:
  ...
  inline static const TransitionTable kTransitionTable{
      {State::IDLE,
       {State::MOVE_ABOVE_OBJECT, State::MOVE_ABOVE_OBJECT,
        State::PLAN_ONLY_COMPLETE}},
      {State::MOVE_ABOVE_OBJECT,
       {State::DESCEND, State::ERROR, State::PLAN_ONLY_COMPLETE}},
      {State::DESCEND,
       {State::CLOSE_GRIPPER, State::CLOSE_GRIPPER, State::PLAN_ONLY_COMPLETE}},
      {State::CLOSE_GRIPPER,
       {State::ATTACH_GAZEBO, State::RECOVER_OPEN_GRIPPER,
        State::PLAN_ONLY_COMPLETE}},
      {State::ATTACH_GAZEBO,
       {State::ATTACH_MOVEIT, State::RECOVER_DETACH_MOVEIT,
        State::PLAN_ONLY_COMPLETE}},
      {State::ATTACH_MOVEIT,
       {State::LIFT, State::RECOVER_DETACH_MOVEIT, State::PLAN_ONLY_COMPLETE}},
      {State::LIFT,
       {State::MOVE_ABOVE_PLACE, State::MOVE_ABOVE_PLACE,
        State::PLAN_ONLY_COMPLETE}},
      {State::MOVE_ABOVE_PLACE,
       {State::DESCEND_TO_PLACE, State::DESCEND_TO_PLACE,
        State::PLAN_ONLY_COMPLETE}},
      {State::DESCEND_TO_PLACE,
       {State::OPEN_GRIPPER, State::OPEN_GRIPPER, State::PLAN_ONLY_COMPLETE}},
      {State::OPEN_GRIPPER,
       {State::DETACH_GAZEBO, State::ERROR, State::PLAN_ONLY_COMPLETE}},
      {State::DETACH_GAZEBO,
       {State::DETACH_MOVEIT, State::ERROR, State::PLAN_ONLY_COMPLETE}},
      {State::DETACH_MOVEIT,
       {State::SYNC_WORLD_OBJECT, State::ERROR, State::PLAN_ONLY_COMPLETE}},
      {State::SYNC_WORLD_OBJECT,
       {State::RETREAT, State::ERROR, State::PLAN_ONLY_COMPLETE}},
