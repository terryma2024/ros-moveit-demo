...
bool isAction(State s) noexcept { return s >= State::PREPARE_OPEN_GRIPPER && s <= State::RECOVER_RETREAT; }
}  // namespace so101_gazebo_demo::pick_place
