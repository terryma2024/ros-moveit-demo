...
const pick_place_common::WorkflowDefinition & so101WorkflowDefinition()
{
  ...
  static const auto workflow = [] {
    ...
    w.transitions = {
      ...
      {S::DESCEND_TO_PLACE, {S::DETACH_MOVEIT, S::RECOVER_LIFT_TO_SAFE_HEIGHT}},
      {S::DETACH_MOVEIT, {S::OPEN_GRIPPER, S::RECOVER_DETACH_MOVEIT}},
      {S::OPEN_GRIPPER, {S::WAIT_RELEASE_SETTLE, S::ERROR}},
