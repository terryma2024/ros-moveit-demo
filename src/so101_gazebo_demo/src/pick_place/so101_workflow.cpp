...
const pick_place_common::WorkflowDefinition & so101WorkflowDefinition()
{
  ...
  static const auto workflow = [] {
    ...
    w.transitions = {
      ...
      {S::VERIFY_PHYSICAL_GRASP, {S::ATTACH_MOVEIT, S::VALIDATION_FAILED}},
      {S::VALIDATION_FAILED, {S::ATTACH_MOVEIT, S::VALIDATION_FAILED}},
      ...
      {S::OPEN_GRIPPER, {S::RETREAT, S::ERROR}},
      {S::RETREAT, {S::DETACH_MOVEIT, S::RECOVER_RETREAT}},
      {S::DETACH_MOVEIT, {S::WAIT_RELEASE_SETTLE, S::RECOVER_DETACH_MOVEIT}},
      {S::WAIT_RELEASE_SETTLE, {S::VALIDATE_FINAL_PLACEMENT, S::ERROR}},
      {S::VALIDATE_FINAL_PLACEMENT, {S::SYNC_WORLD_OBJECT, S::ERROR}},
      {S::SYNC_WORLD_OBJECT, {S::DONE, S::RECOVER_SYNC_WORLD_OBJECT}},
      ...
      {S::RECOVER_OPEN_GRIPPER, {S::RECOVER_DETACH_MOVEIT, S::ERROR}},
