...
if(DEFINED QUALITY_SOURCE_MANIFEST)
  if(NOT EXISTS "${QUALITY_SOURCE_MANIFEST}")
    message(FATAL_ERROR "QUALITY_SOURCE_MANIFEST does not exist: ${QUALITY_SOURCE_MANIFEST}")
  endif()
...
if(NOT EXISTS "${COMPILATION_DATABASE_DIR}/compile_commands.json")
  message(FATAL_ERROR "Compilation database is missing: ${COMPILATION_DATABASE_DIR}/compile_commands.json")
endif()
foreach(config_file IN ITEMS "${WORKSPACE_ROOT}/.clang-tidy" "${WORKSPACE_ROOT}/.clang-format")
