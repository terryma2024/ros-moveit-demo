...
export type StartGuardStatus = Schemas["StartGuardStatus"];
export type StartGuardCheck = Schemas["StartGuardCheck"];
export type StartGuardPolicy = Schemas["StartGuardPolicyResponse"];
