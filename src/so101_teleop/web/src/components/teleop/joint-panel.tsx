...
export function JointPanel({ joints, targets, leaseHeld, manualJointExecute = true, plan, onEdit, onClampNotice, onPlan, onExecute, onExecuteGripper, onExecuteAll, onCancel }: Props) {
  ...
  return <Card>
    ...
    <p className="mb-3 text-sm text-muted-foreground">Axes 1–5 are MoveIt arm joints. Axis 6 uses the gripper controller.</p>
    ...
    {blocked && <p className="mt-3 text-warning">Acquire a control lease before planning.</p>}
